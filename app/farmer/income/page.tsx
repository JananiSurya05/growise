        ...
        <main style={{
                    ...
                    {[
                        ...
                        <a key={i} href={item.href} style={{ textDecoration: "none" }}>
                            <div style={{
                                ...
                                background: item.active ? "rgba(251,191,36,0.12)" : "transparent",
                                border: item.active ? "1px solid rgba(251,191,36,0.22)" : "1px solid transparent",
                            }}>
                                <span style={{ fontSize: "14px" }}>{item.icon}</span>
                                <span style={{ fontSize: "12px", fontWeight: item.active ? "600" : "400", color: item.active ? "#fbbf24" : "rgba(255,255,255,0.4)" }}>
                                    {item.label}
                                </span>
                            </div>
                        </a>
            ...
            <div style={{ marginLeft: "200px", flex: 1, padding: "24px 28px" }}>
                ...
                <div style={{
                    ...
                    overflow: "hidden", marginBottom: "24px", height: "130px"
                }}>
                    <img
                    ...
                    <div style={{ position: "absolute", inset: 0, padding: "20px 24px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                        ...
                        <div style={{ display: "flex", gap: "24px" }}>
                            {[
                                { label: "Middleman cut", value: "45%" },
                                { label: "Avg farmer gain", value: "+₹8,200/mo" },
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "20px" }}>
                    ...
                    <div>
                        ...
                        <div style={{
                            ...
                            <div style={{ fontSize: "11px", color: "rgba(255,255,255,0.4)", marginBottom: "12px", textTransform: "uppercase", letterSpacing: ".06em" }}>
                                Quick select crop
                            </div>
                            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "8px" }}>
                                {presets.map((p, i) => (
                                    <button key={i} onClick={() => { setCrop(p.crop); setPrice(p.price.toString()); }} style={{
                                        background: crop === p.crop ? "rgba(251,191,36,0.15)" : "rgba(255,255,255,0.03)",
                                        border: crop === p.crop ? "1px solid rgba(251,191,36,0.4)" : "1px solid rgba(255,255,255,0.07)",
                        ...
                        <div style={{
                            ...
                            <div style={{ fontSize: "11px", color: "rgba(255,255,255,0.4)", marginBottom: "14px", textTransform: "uppercase", letterSpacing: ".06em" }}>
                                Enter your details
                            </div>
                            <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                                {[
                                    { label: "Crop Name", value: crop, set: setCrop, placeholder: "e.g. Tomato" },
                                    { label: "Quantity (kg)", value: quantity, set: setQuantity, placeholder: "e.g. 100", type: "number" },
                                    { label: "Your Price per kg (₹)", value: price, set: setPrice, placeholder: "e.g. 25", type: "number" },
                                ].map((f, i) => (
                                    <div key={i}>
                        ...
                        {!result && (
                            <>
                                ...
                                <div style={{
                                    ...
                                    {[
                                        { label: "You sell 100kg tomato at ₹25/kg", value: "₹2,500 total" },
                                        { label: "Middleman takes 45%", value: "−₹1,125" },
                                        { label: "You receive only", value: "₹1,375 😞" },
                                    ].map((r, i) => (
                                ...
                                <div style={{
                                    ...
                                    <div style={{ fontSize: "12px", color: "#4ade80", fontWeight: "600", marginBottom: "14px", textTransform: "uppercase", letterSpacing: ".06em" }}>
                                        ✅ The GroWise solution
                                    </div>
                                    {[
                                        { label: "You sell 100kg tomato at ₹25/kg", value: "₹2,500 total" },
                                        { label: "GroWise platform fee", value: "₹0 free" },
                                        { label: "You receive full amount", value: "₹2,500 😊" },
                                    ].map((r, i) => (
                                        <div key={i} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "10px 0", borderBottom: i < 2 ? "1px solid rgba(255,255,255,0.05)" : "none" }}>
                                            <span style={{ fontSize: "12px", color: "rgba(255,255,255,0.5)" }}>{r.label}</span>
                                ...
                                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "10px" }}>
                                    {[
                                        { label: "Avg saving", value: "₹8,200", sub: "per month", color: "#4ade80" },
                                        { label: "Farmers saved", value: "500+", sub: "on GroWise", color: "#60a5fa" },
                                        { label: "Middlemen cut", value: "45%", sub: "typical cut", color: "#f87171" },
                                    ].map((s, i) => (
                                        <div key={i} style={{
                                            background: "#012e2f",
                                            border: "1px solid rgba(255,255,255,0.07)",
                            ...
                            <>
                                ...
                                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px" }}>
                                    <div style={{
                                        ...
                                        <div style={{ fontSize: "11px", color: "#4ade80", fontWeight: "600", marginBottom: "8px", textTransform: "uppercase", letterSpacing: ".05em" }}>✅ On GroWise</div>
                                    ...
                                    <div style={{
                                        ...
                                        <div style={{ fontSize: "11px", color: "#f87171", fontWeight: "600", marginBottom: "8px", textTransform: "uppercase", letterSpacing: ".05em" }}>❌ Via Middleman</div>
                                ...
                                <div style={{
                                    ...
                                    <div style={{ fontSize: "12px", color: "#fbbf24", fontWeight: "600", marginBottom: "8px", textTransform: "uppercase", letterSpacing: ".06em" }}>
                                        💰 Extra money in your pocket
                                    </div>
                                    <div style={{ fontSize: "48px", fontWeight: "800", color: "#fbbf24", marginBottom: "4px" }}>
                                        ₹{result.saved.toLocaleString()}
                                    </div>
                                    <div style={{ fontSize: "14px", color: "rgba(255,255,255,0.5)" }}>
                                        That's {result.percent}% more income for selling {quantity}kg of {crop}
                                    </div>
                                </div>
                                ...
                                <div style={{ background: "#012e2f", border: "1px solid rgba(255,255,255,0.07)", borderRadius: "16px", padding: "18px" }}>
                                    <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "8px" }}>
                                        <span style={{ fontSize: "12px", color: "rgba(255,255,255,0.5)" }}>Middleman gets</span>
                                        <span style={{ fontSize: "12px", color: "rgba(255,255,255,0.5)" }}>You keep on GroWise</span>
                                    </div>
                                    <div style={{ height: "10px", background: "rgba(255,255,255,0.05)", borderRadius: "5px", overflow: "hidden" }}>
                                        <div style={{ display: "flex", height: "100%" }}>
                                            <div style={{ width: "45%", background: "#f87171" }} />
                                            <div style={{ width: "55%", background: "#4ade80" }} />
                                        </div>
                                    </div>
                                    <div style={{ display: "flex", justifyContent: "space-between", marginTop: "6px" }}>
                                        <span style={{ fontSize: "11px", color: "#f87171" }}>45% = ₹{result.saved.toLocaleString()}</span>
                                        <span style={{ fontSize: "11px", color: "#4ade80" }}>55% = ₹{result.middleman.toLocaleString()}</span>
                                    </div>
                                </div>
                                ...
                                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "10px" }}>
                                    {[
                                        { label: "Monthly (x4 sells)", value: `₹${(result.saved * 4).toLocaleString()}`, color: "#4ade80" },
                                        { label: "Yearly savings", value: `₹${(result.saved * 48).toLocaleString()}`, color: "#fbbf24" },
                                        { label: "5 year savings", value: `₹${(result.saved * 240).toLocaleString()}`, color: "#a78bfa" },
                                    ].map((s, i) => (
                                ...
                                <button onClick={() => { setResult(null); setCrop(""); setQuantity(""); setPrice(""); }} style={{
                                    background: "rgba(255,255,255,0.05)",
                                    border: "1px solid rgba(255,255,255,0.1)",
