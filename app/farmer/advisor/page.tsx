                    ...
                    {[
                        ...
                        <a key={i} href={item.href} style={{ textDecoration: "none" }}>
                            <div style={{
                                ...
                                background: item.active ? "rgba(74,222,128,0.12)" : "transparent",
                                border: item.active ? "1px solid rgba(74,222,128,0.22)" : "1px solid transparent",
                            }}>
                                <span style={{ fontSize: "14px" }}>{item.icon}</span>
                                <span style={{ fontSize: "12px", fontWeight: item.active ? "600" : "400", color: item.active ? "#4ade80" : "rgba(255,255,255,0.4)" }}>
                                    {item.label}
                                </span>
                            </div>
                        </a>
                    ...
                    <div style={{
                        ...
                        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                            <div style={{
                                ...
                                background: "linear-gradient(135deg, #014D4E, #016b6c)",
                                border: "2px solid rgba(74,222,128,0.4)",
                                display: "flex", alignItems: "center", justifyContent: "center",
                                fontSize: "22px", flexShrink: 0
                            }}>🤖</div>
                            <div>
                                <h1 style={{ fontSize: "17px", fontWeight: "800", color: "white", marginBottom: "3px" }}>
                                    AI Crop Advisor
                                </h1>
                ...
                <div style={{
                    ...
                    {messages.map((msg, i) => (
                        <div key={i} style={{
                            ...
                            <div style={{
                                maxWidth: "68%",
                                background: msg.role === "user" ? "#015f60" : "#012e2f",
                                ...
                                {msg.role === "ai" && (
                                    <div style={{ fontSize: "10px", color: "#4ade80", fontWeight: "600", marginBottom: "6px", letterSpacing: ".05em" }}>
                                        🤖 AI CROP ADVISOR
                                    </div>
                                )}
                                <div style={{
                    ...
                    {loading && (
                        <div style={{ display: "flex", gap: "10px", alignItems: "flex-start" }}>
                            ...
                            <div style={{
                                ...
                                <div style={{ fontSize: "10px", color: "#4ade80", fontWeight: "600", marginBottom: "8px" }}>
                                    🤖 AI CROP ADVISOR
                                </div>
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <textarea
                            ...
                            placeholder="Describe your crop problem... (Enter to send, Shift+Enter for new line)"
                            rows={2}
                            style={{
                        ...
                        <button
                            ...
                            disabled={loading}
                            style={{
                                background: loading ? "rgba(74,222,128,0.2)" : "#4ade80",
                                border: "none", borderRadius: "10px",
                                padding: "10px 20px", fontSize: "13px",
                                fontWeight: "700", color: loading ? "#4ade80" : "#0a0a0a",
                    ...
                    <div style={{ fontSize: "10px", color: "rgba(255,255,255,0.2)", marginTop: "6px", textAlign: "center" }}>
                        Powered by Llama AI · Press Enter to send · Shift+Enter for new line
                    </div>
                </div>
            </div>
