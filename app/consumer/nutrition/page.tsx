            ...
            <div style={{ marginLeft: "200px", flex: 1, padding: "24px 28px" }}>
                ...
                <div style={{ position: "relative", borderRadius: "20px", overflow: "hidden", marginBottom: "20px", height: "100px" }}>
                    ...
                    <div style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 24px" }}>
                        ...
                        <div style={{ display: "flex", gap: "28px" }}>
                            {[
                                { label: "Crops Tracked", value: seasonal.length, color: "#4ade80" },
                                { label: "Diet Plans", value: diets.length, color: "#60a5fa" },
                                { label: "Avg Nutrition Score", value: "87/100", color: "#fbbf24" },
                            ].map((s, i) => (
                ...
                <div style={{ marginBottom: "20px" }}>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "10px" }}>
                        {diets.map((diet, i) => (
                            <div key={i} onClick={() => setSelectedDiet(selectedDiet?.name === diet.name ? null : diet)}
                                style={{
                                    background: selectedDiet?.name === diet.name ? "rgba(74,222,128,0.1)" : "#012e2f",
                                    border: selectedDiet?.name === diet.name ? "2px solid rgba(74,222,128,0.35)" : "1px solid rgba(255,255,255,0.07)",
                ...
                <div style={{ display: "grid", gridTemplateColumns: selectedCrop ? "1fr 320px" : "1fr", gap: "20px" }}>
                    <div>
                        ...
                        <div style={{ display: "grid", gridTemplateColumns: selectedCrop ? "repeat(2, 1fr)" : "repeat(3, 1fr)", gap: "12px" }}>
                            {seasonal.map((crop, i) => (
                                <div key={i} onClick={() => setSelectedCrop(selectedCrop?.name === crop.name ? null : crop)}
                                    style={{
                                        background: selectedCrop?.name === crop.name ? "rgba(96,165,250,0.06)" : "#012e2f",
                                        border: selectedCrop?.name === crop.name ? "2px solid rgba(96,165,250,0.3)" : "1px solid rgba(255,255,255,0.07)",
                                    ...
                                    <div style={{ position: "relative", height: "100px" }}>
                                        ...
                                        <div style={{ position: "absolute", top: "8px", right: "8px" }}>
                                            <div style={{ background: crop.score >= 90 ? "rgba(74,222,128,0.8)" : crop.score >= 80 ? "rgba(251,191,36,0.8)" : "rgba(96,165,250,0.8)", borderRadius: "999px", padding: "2px 8px", fontSize: "9px", color: "white", fontWeight: "700" }}>
                                                {crop.score}/100
                                            </div>
                                        </div>
                    ...
                    {selectedCrop && (
                        <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                            <div style={{ borderRadius: "14px", overflow: "hidden", position: "relative", height: "140px" }}>
                                ...
                                <div style={{ position: "absolute", top: "12px", right: "12px", background: selectedCrop.score >= 90 ? "rgba(74,222,128,0.8)" : "rgba(251,191,36,0.8)", borderRadius: "999px", padding: "4px 12px", fontSize: "11px", color: "white", fontWeight: "700" }}>
                                    Score: {selectedCrop.score}/100
                                </div>
                            </div>
                            ...
                            <div style={{ background: "#012e2f", border: "1px solid rgba(255,255,255,0.07)", borderRadius: "14px", padding: "14px" }}>
                                ...
                                {[
                                    { label: "Calories", value: `${selectedCrop.calories} kcal/100g`, color: "#fbbf24" },
                                    { label: "Protein", value: selectedCrop.protein, color: "#60a5fa" },
                                    { label: "Key Vitamins", value: selectedCrop.vitamin, color: "#4ade80" },
                                    { label: "Season", value: selectedCrop.season, color: "#a78bfa" },
                                ].map((d, i) => (
